    ...
    <>
      <header className="py-4 px-6 lg:px-16 flex justify-between items-center">
        ...
        <nav id="nav-menu" className="hidden md:flex space-x-6">
          ...
          <Link href="/store" className="text-yellow-400 font-bold">App Store</Link>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            id="hamburger"
            className="md:hidden text-gray-600 hover:text-yellow-400 transition-colors duration-200"
            onClick={toggleMenu}
      ...
      <div id="menu-overlay" className="menu-overlay">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <Link href="/store" onClick={closeMenu} className="text-2xl font-semibold text-yellow-400 font-bold">
            App Store
          </Link>
